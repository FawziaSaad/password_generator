...
class View:
    def __init__(self, main):
        ...
        self.length_slider = CTkSlider(self.main, variable = self.model.length, from_=4, to=100, orientation='vertical')
        ...
        self.special_checkbutton = CTkCheckBox(self.main, text='Special Characters', variable=self.model.special_characters)
